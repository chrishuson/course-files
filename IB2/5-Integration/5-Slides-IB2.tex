...
{
  \frametitle{GQ: How do we integrate compositions of linear functions?}
  \framesubtitle{CCSS: F.IF.B.6 Calculate \& interpret the rate of change of a function \hspace{\stretch{1}} \alert{5.7 Monday 14 January}}
...
{
  \frametitle{GQ: How do we integrate functions?}
  \framesubtitle{CCSS: F.IF.B.6 Calculate \& interpret the rate of change of a function \hspace{\stretch{1}} \alert{5.8  Tuesday 15 January}}
...
\frame
{
  ...
  \framesubtitle{CCSS: F.IF.B.6 Calculate \& interpret the rate of change of a function \hspace{\stretch{1}} \alert{5.9 Wednesday 16 January}}
  ...
  \frame
  {
    ...
    \framesubtitle{CCSS: F.IF.B.6 Calculate \& interpret the rate of change of a function \hspace{\stretch{1}} \alert{5.10 Thursday 17 January}}
  ...
  \frame
  {
    ...
    \framesubtitle{CCSS: F.IF.B.6 Calculate \& interpret the rate of change of a function \hspace{\stretch{1}} \alert{5.11 Friday 18 January}}
  ...
  {
    \frametitle{GQ: How do we calculate area with definite integrals?}
    \framesubtitle{CCSS: F.IF.B.6 Calculate \& interpret the rate of change of a function \hspace{\stretch{1}} \alert{5.12 Tuesday 29 January}}
  ...
  \frame
  {
    ...
    \framesubtitle{CCSS: F.IF.B.6 Calculate \& interpret the rate of change of a function \hspace{\stretch{1}} \alert{5.13 Wednesday 30 January}}
  ...
  \frame
  {
    ...
    \framesubtitle{CCSS: F.IF.B.6 Calculate \& interpret the rate of change of a function \hspace{\stretch{1}} \alert{Cold-day, Thursday 31  January}}
  ...
  \frame
  {
    ...
    \framesubtitle{CCSS: F.IF.B.6 Calculate \& interpret the rate of change of a function \hspace{\stretch{1}} \alert{5.14 Friday 1 February}}
  ...
  \section{5.15 Volumes of rotation. Monday 4 February (delay 1 week)}
  \frame
  {
    \frametitle{GQ: How do we calculate a volume of rotation?}
    \framesubtitle{CCSS: F.IF.B.6 Calculate \& interpret the rate of change of a function \hspace{\stretch{1}} \alert{5.15 Monday 4 February}}
  ...
  {
    \frametitle{GQ: How do we calculate a volume of rotation?}
    \framesubtitle{CCSS: F.IF.B.6 Calculate \& interpret the rate of change of a function \hspace{\stretch{1}} \alert{5.16 Wednesday 6 February February}}
