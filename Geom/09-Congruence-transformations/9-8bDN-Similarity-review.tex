...
\fancyhead[LO]{BECA / Dr. Huson / Geometry\\* Unit 9: Congruence \& similarity transformations\\* 5 March 2020}
...
\newpage
  ...
  \item Given $\triangle ABC \sim \triangle AED$ shown below, $\angle ACB$ is a right angle, $E$ is a point on $\overline{AC}$, and $\overline{ED}$ is drawn perpendicular to hypontenuse $\overline{AB}$. 
    \begin{center}
