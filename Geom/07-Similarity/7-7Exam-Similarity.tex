...
\fancyhead[LO]{BECA / Dr. Huson / Geometry\\* Unit 6: Distance \& slope\\* 12 December 2019}
...
\newpage
  \item Given two parallel lines and a transversal, as shown below. Given $m\angle 1 = 108$.
  \begin{center}
  ...
  \item In the diagram below, the chords $\overline{AE}$ and $\overline{BD}$ intersect at $C$. Given $\triangle ABC \sim \triangle DEC$, $BC=6$, $CD=10$, and $CE=8$. Determine the length of $\overline{CD}$.
    \begin{flushright}
