...
\subsubsection*{Regents problems August 2019}
  \begin{enumerate}
    ...
    \item On the set of axes below, $\overline{AB}$ is dilated with a scale factor of $\frac{5}{2}$ centered at point $P$.\\[0.25cm]
    ...
    \item Graphing (scaffold to graph on exam stationary)
    \item The coordinates of the vertices of parallelogram $CDEH$ are $C(-5,5)$, $D(2,5)$, $E(-1,-1)$, and $H(-8,-1)$. What are the coordinates of $P$, the point of intersection of diagonals $\overline{CE}$ and $\overline{DH}$?
