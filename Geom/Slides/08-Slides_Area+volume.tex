...
\frame
{
  ...
  \framesubtitle{CCSS: HSG.GPE.A1 Equation of a circle of given center and radius \hfill \alert{8.6 Tuesday 4 February}}
  ...
  If extra time: Expand equation of a circle $(x-a)^2+(y-b)^2=r^2 \rightarrow x^2-2ax+y^2-2by=r^2-a^2-b^2$\\[5pt]
  Homework: Deltamath due 10:00pm
}

\section{8.7 Rotations in 3-dimensions, Cross sections, Wednesday 5 February}
\frame
{
  \frametitle{GQ: How do we imagine a figure rotated in space?}
  \framesubtitle{CCSS: HSG.GPE.A1 Equation of a circle of given center and radius \hfill \alert{8.7 Wednesday 5 February}}
  ...
  \end{block}
  Lesson: Rotations in 3-dimensions, Cross sections\\*[5pt]
  Calculator graphing equation of a circle $(x-a)^2+(y-b)^2=r^2 \rightarrow x^2-2ax+y^2-2by=r^2-a^2-b^2$\\[5pt]
  Homework: Deltamath due 10:00pm
}
