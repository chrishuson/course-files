...
\newpage
  ...
  \item The circle with center $B$ is shown below with diameter $\overline{AC}$ and radius $\overline{BD}$. Given $BC=3x+15$ and $BD=2x+5$. Find the diameter of the circle.
  \begin{flushright}
