...
\fancyhead[L]{BECA / Dr. Huson / Geometry 10th Grade\\* Unit 3: Volume and angle bisectors \\ 17 October 2019}

\begin{document}
\subsubsection*{3.8 Exam: Area, volume, perimeter; line segments and angles}
  \vspace{0.25cm}
  \begin{enumerate}
...
\item Find the area of $\triangle CAT$. The altitude $h$ of the triangle is 6.7 centimeters and the base $CA=13.3$ cm.\\[0.5cm]
