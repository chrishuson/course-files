...
\newpage
  ...
  \item A dilation centered at $A$ maps $\triangle ABC \rightarrow \triangle ADE$. Given the sides of the preimage, $AC = 4$, $BC = 3$, $AB = 5$, and of $DE = 7.5$ find the scale factor $k$ and the lengths $AD$ and $AE$.
    ...
    \item Given $\triangle ABC \sim \triangle DEF$. $m\angle A = 40^\circ$ and $m\angle E = 35^\circ$. Find the measure of $\angle C$.
...
\newpage
  ...
  \item $\triangle ABC$ is shown with vertices $A(2,-3)$, $B(8,1)$, and $C(3,4)$. Reflect the triangle across the $x$-axis. Write down its coordinates in a table and plot and label it on the graph.
    \begin{flushright}
      \begin{tikzpicture}[scale=.48]
...
\newpage
  ...
  \item One side of the $\triangle ABC$ has a length $AB=15$. The triangle's area is $71 \frac{1}{4}$. Find the length of the altitude $h$ of the triangle to vertex $C$ and perpendicular to side $\overline{AB}$.\\[0.5cm]
  ...
  \item The point $K$ is the midpoint of $\overline{JL}$, $JK=3x+11$, and $JL=9x+1$. Find ${JK}$.  \vspace{1cm}
  \begin{flushright}
    \begin{tikzpicture}
      \draw [-, thick] (0,0)--(6,0);
