...
\newpage
  ...
  \item $\triangle ABC$ is shown with vertices $A(2,-3)$, $B(8,1)$, and $C(-1,8)$. Reflect the triangle across the $x$-axis. Write down its coordinates in a table and plot and label it on the graph.
    \begin{flushright}
      \begin{tikzpicture}[scale=.48]
