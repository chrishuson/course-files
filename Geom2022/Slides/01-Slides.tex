...
\frame
{
  ...
  \end{enumerate}
  \end{block}
  Lesson: Angle measures; Practice segment addition \& congruence 
}
  ...
  \frame
  {
    ...
    Rays $\overrightarrow{BA}$ and $\overrightarrow{BC}$. Vertex $B$. \hspace{2cm}
    Called $\angle ABC$ or $\angle B$. \\[0.75cm]
          \begin{center}
            \begin{tikzpicture}
