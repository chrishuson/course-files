...
\subsubsection*{3.8 Triangle angles}
\begin{enumerate}
  \item Do Now: Given isosceles $\triangle LMN$, $\overline{LM} \cong \overline{NM}$. If $m\angle L=5x-3$ and $m\angle N=7x-27$, find $m\angle M$.
  \begin{flushright}
...
\end{multicols} \vspace{4cm}
  ...
  \newpage
  \item Given $\triangle RSU$. If $m\angle UST=x+50$ and $m\angle R=x-20$, and $m\angle U=x+10$.
  \begin{flushright}
  \begin{tikzpicture}[scale=0.8]
    %\draw [->, thick] (0,0)--(5,5);
    \draw [<-, thick] (8,0)--
