...
\fancyhead[L]{BECA / Dr. Huson / 10th Grade Geometry\\* Geometry Trimester 2: Credit Recovery\\Summer 2019}

\begin{document}
\subsubsection*{Part 1, Transformational Geometry: Similarity \& Congruence}
  \begin{enumerate}
    ...
    \item Given two parallel lines and a transversal, as shown below.
      ...
      \begin{enumerate}
        ...
        \item In a proof, what reason would justify $m\angle 5 + m\angle 6 =180^
        \circ$? \rule{6cm}{0.15mm}
      \end{enumerate}
...
\newpage
\subsubsection*{Part 2, Transformational Geometry: Similarity \& Congruence}
