...
\section{4.8 Graphing quadratic functions Wednesday 15 January}
\frame
{
  \frametitle{GQ: How do we graph quadratic functions?}
  \framesubtitle{CCSS: HSS.CP.A.4 Understand linear functions \hfill \alert{4.8 Wednesday 15 January}}
