...
\section{5.8 The discriminant \hfill Friday 7 February}
\frame
{
  \frametitle{GQ: How do we graph polynomial functions?}
  \framesubtitle{CCSS: HSF.IF.C8.A Complete the square of quadratic functions \hfill \alert{5.8 Friday 7 February}}
