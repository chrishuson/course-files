...
1.6|How do we measure angles?|Do Now quiz: notation, segment addition algebra, absolute value, equilateral triangle construction|Angle terminology, types; protractor use pp. 27-29, #1-20 p.31|Angle notation
1.7| How do we solve for angle measures?||Inverses|Study for test
1.8| How do we work with functions, algebraically and graphically? || Test


<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMDM3MzQ1MDAsMTU5NjExNjUyMCwtMT
c5NzIxNzc3NCwyMjA1NTU2OTQsLTE0NzUzMTEyMzIsMjUzNDM1
NTcyXX0=
-->