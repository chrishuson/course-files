...
\frame
{
  ...
  \framesubtitle{CCSS: HSS.CP.B.6 Probabilities \qquad \qquad \qquad \alert{11.1}}

  \begin{block}{Do Now: IB Exam-style problems}
  \begin{enumerate}
      \item Exercises 3D \#3, 4 page 77.
      \item Review homework problems p. 79.
  \end{enumerate}
  \end{block}
  ...
  Homework: Exercises 3F page 82-3.  
}
