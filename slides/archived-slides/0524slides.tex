...
\begin{block}{Do Now handout: Sine graph, modeling}
  ...
  \begin{enumerate}
    ...
    \end{enumerate}
  \end{block}
  Lesson: The law of cosines p. 386\\*
  %Task: Textbook notes p. 362-9 \\*
  Assessment: Exercise 11H \#3 p. 385\\*
  Homework: Take home test %Read through p. 388; Exercises 11I \#1-4 p. 383\\
}
