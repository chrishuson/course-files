...
\frame
{
  \frametitle{How do we connect polynomials' graphs and equations?}
  \framesubtitle{HSF.LB.B.5 Interpret the parameters in a polynomial function in context \qquad \alert{11.2}}
...
\begin{block}{Do Now Quiz: Trig handout}
    %\emph{Complete on lined paper to hand in. Work independently.}}
  \begin{enumerate}
    \item Learn to use the unit circle from memory
    \item The laws of sines, cosines
    \end{enumerate}
  \end{block}
  Lesson: The period of trigonometric functions p. 476, radian measures (arc length \& sector area) p. 391\\*
  Task: Textbook notes, Examples 18 \& 19, p. 392\\*
  Assessment: Paper peer review (calendar); test corrections\\*
  Homework:  Read through p. 388; Exercises 11I \#1-4 p. 383\\
}
