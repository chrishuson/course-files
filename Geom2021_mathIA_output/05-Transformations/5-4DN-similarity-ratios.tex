...
\fancyhead[L]{BECA / Dr. Huson / Geometry 05-Transformations\\* pset ID: 62}

\begin{document}

\subsubsection*{5-4DN-similarity-ratios}
\begin{enumerate}
...
\item Given similar triangles $\triangle ABC \sim \triangle ADE$, as shown. Given $AB=5$, $BC=7$, $AC=8$, and $BD=5$. \\[0.25cm] Find the scale factor $k$, $DE$, $AE$, and $CE$. \vspace{1cm}
\begin{flushright}
...
\item Given $\triangle ABP \sim \triangle JKP$ as shown below. $AP=5.7$, $JP=11.4$, and $JK=14.8$. Find $AB$.
 \begin{flushright}
