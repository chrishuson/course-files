...
\fancyhead[LO]{BECA / Dr. Huson / Geometry 09-Congruence-transformations\\* pset ID: 164}

\begin{document}

\subsubsection*{9-9bExam-transformations}
\begin{enumerate}
...
\item Given $\triangle PQR \sim \triangle STU$, $m\angle P=37^\circ$, and $m\angle T=46^\circ$. Find $m\angle R$. \vspace{1cm}
