...
\fancyhead[L]{BECA / Dr. Huson / Geometry 06-Analytic-geometry\\* pset ID: 95}

\begin{document}

\subsubsection*{6-9HW-pretest-graphing}
\begin{enumerate}
\item Checklist:
  \begin{itemize}
...
\newpage
\item Note: The formula for distance is $\displaystyle d=\sqrt{(x_2-x_1)^2+(y_2-y_1)^2}$ \\
