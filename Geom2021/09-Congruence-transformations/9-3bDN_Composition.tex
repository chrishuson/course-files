...
\fancyhead[LO]{BECA / Dr. Huson / Geometry 09-Congruence-transformations\\* pset ID: 153}

\begin{document}

\subsubsection*{9-3bDN-Composition}
\begin{enumerate}
\item A transformation is applied to a triangle, $\triangle CAT \rightarrow \triangle C'A'T'$.  Circle True or False to identify each transformation correctly represented below.  \vspace{0.5cm}
  \begin{multicols}{2}
    \begin{itemize}
      \item[T \quad F \quad] Translated six to the left, up two
      ...
      \item[T \quad F \quad] A slide six units to the right, up two
    \end{itemize}
