...
\lhead{BECA / Dr. Huson / 10.3 Geometry\\* 5 June 2019}
...
\begin{document}
  \begin{enumerate}
    \subsubsection*{Do Now: Graphing practice}
        ...
        \item Graph the line $y=-\frac{3}{4} x +2$ after filling in the values in the blanks.\\[0.85cm]
        ...
        \begin{multicols}{2}
        \item   $3x+6=5x-14$ \vspace{3cm}
        \item   $\frac{3}{2}(2x+10)=21$ %\vspace{3cm}
        \end{multicols}
...
\item The weight of chickens increases as they get older. The table shows the weights and ages of a number of chickens.
  \renewcommand{\arraystretch}{1.6}
    ...
    \begin{tikzpicture}[scale=.635]
      ...
      \draw [thick, ->] (0,0) -- (14.4,0) node [below right] {$Age$};
      \draw [thick, ->] (0,0)--(0,12.4) node [left] {$Weight$};
      \node at (15,10)[right]{Calculator};
      \node at (15,9)[right]{$ax+b$};
      \node at (15,7)[right]{$a= \rule{2cm}{0.1mm}$};
      \node at (15,5)[right]{$b= \rule{2cm}{0.1mm}$};
      \node at (15,3)[right]{$r= \rule{2cm}{0.1mm}$};
    \end{tikzpicture}
    \end{center}
