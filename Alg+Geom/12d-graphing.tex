...
\fancyhead[L]{BECA / Dr. Huson / 10.3 Geometry\\* 4 January 2019}
...
Show your work. For graphs, use a pencil and straight edge. Graph the inequality after filling in the values in the blanks and circling the correct types.
  \begin{enumerate}
    ...
    \item Solve for $y$, then complete. $\displaystyle x+ \frac{1}{2} y \leq -1 $

        \vspace{3cm}
        \begin{multicols}{2}
          \raggedcolumns
          $y$-intercept $b= \rule{2cm}{0.15mm}$ \\[0.5cm]
          Slope \hspace{0.8cm} $m= \rule{2cm}{0.15mm}$\\
...
Show your work. For graphs, {\large use a pencil and straight edge}. Graph the inequality after filling in the values in the blanks and circling the correct types.
  \begin{enumerate}
    ...
    \item $\displaystyle y \leq \frac{3}{4} x  -2 $
    ...
    \item Solve for $y$, then complete. $\displaystyle \frac{3}{4} x - 3y \geq 3 $
