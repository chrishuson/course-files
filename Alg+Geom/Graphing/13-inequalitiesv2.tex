...
\fancyhead[L]{BECA / Dr. Huson / 10.3 Geometry\\* 7 January 2019}
...
\item Solve for $y$, then graph the two inequalities.
  ...
  \begin{multicols}{2}
    \raggedcolumns
    \begin{enumerate}
      \item $(8,2)$ \hspace{0.4cm} Yes \hspace{0.4cm} No
      \item $(-3,6)$ \hspace{0.4cm} Yes \hspace{0.4cm} No
      \item $(1,3)$ \hspace{0.4cm} Yes \hspace{0.4cm} No
      \item $(-2,-5)$ \hspace{0.4cm} Yes \hspace{0.4cm} No
    \end{enumerate}
  \end{multicols}
