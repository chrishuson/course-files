...
\fancyhead[L]{BECA / Dr. Huson / 10.3 Geometry\\* 10 December 2018}
...
Show your work. For graphs, use a pencil and straight edge. Graph the inequality after filling in the values in the blanks and circling the correct types.
  \begin{enumerate}
    ...
    \item $\displaystyle y \leq \frac{3}{2} x -2 $
    ...
    \item Solve for $y$, then complete. $\displaystyle \frac{2}{3} x+ y > -2 $
