...
\fancyhead[L]{BECA / Dr. Huson / 10.3 Geometry\\* 10 April 2019}
...
\item Solve for $y$, then graph the two inequalities.
  ...
  Mark the solution set with a capital ``S". Is the point $(-2,6)$ a solution? Justify your answer.
\newpage
...
\item Does the table represent a linear function? Justify your answer.
  \renewcommand{\arraystretch}{1.6}
    ...
    \end{center}
 \vspace{2cm}
    \item Given $f(x)=2x+3$. Simplify $f(3)$. \vspace{3cm}
    \item Find $g(x)=\frac{1}{3} x-3$ for $x=6$. \vspace{3.5cm}
    \item Given $\displaystyle h(x)=\frac{3x+3}{6}$. Evaluate the expression $h(-2)$. \vspace{4cm}
