...
\fancyhead[L]{BECA / Dr. Huson / 10.3 Geometry\\* 7 December 2018}
...
\begin{multicols}{2}
  \item $x(x+1)$ \vspace{3cm}
  \item $(x+5)(x+1)$ \vspace{3cm}
  \item $(x-7)(x+7)$ \vspace{3cm}
  \item $(x+1)(x+4)$ \vspace{4cm}
  \item $(x+5)(x-5)$ \vspace{3cm}

Factor each expression
    \item $x^2+3x$ \vspace{2cm}
    \item $x^2+12x+11$ \vspace{3cm}
    \item $x^2+4x+3$ \vspace{3cm}
    \item $x^2+6x+9$ \vspace{4cm}
    \item $x^2+7x+6$ \vspace{3cm}
  \end{multicols}
