...
A small rectangular window has a perimeter of 220 centimeters.
    ...
    \end{enumerate}
    \begin{center}
    \begin{tikzpicture}[x=0.1cm, y=0.002cm]
        \draw [thin, color=lightgray, xstep=1.0cm,ystep=1.0cm] (0,0) grid (140,4010);
        \foreach \x in {0,10,...,140}
            \draw[shift={(\x,0)}] (0,3pt)--(0,-3pt) node[below]{$\x$};
        \foreach \y in {0,500,...,4000}
            \draw[shift={(0,\y)}] (2pt,0pt)--(-2pt,0pt) node[left]{$\y$};
        \draw [thick, ->] (0,0) -- (+142,0) node [above] {$x$};
        \draw [thick, ->] (0,0) -- (0,4100) node [above right] {$A$};
        %\draw [thick, <->,smooth,domain=0:110] plot(\x,-\x*\x+110*\x);
    \end{tikzpicture}
    \end{center}
