...
\begin{enumerate}
    ...
    \end{flushright}
      ...
      \begin{tikzpicture}[yscale=0.5]
          ...
          \draw (0.5,-12.5) circle[radius=2pt] node [below right] {$(0.5,-12.5)$};
          \fill (0.5,-12.5) circle[radius=2pt];
          \draw (-2,0) circle[radius=2pt] node [above left] {$(-2,0)$};
          \fill (-2,0) circle[radius=2pt];
          \draw (3,0) circle[radius=2pt] node [above left] {$(p,0)$};
          \fill (3,0) circle[radius=2pt];
          \draw [<->] plot[domain= -2.25:3.25] (\x, 2*\x*\x -2*\x -12);
      \end{tikzpicture}
      \end{center}
