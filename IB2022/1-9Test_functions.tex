...
\item Given the linear function $f(x)=-3x+9$. \hfill [6]
\begin{enumerate}
  \begin{multicols}{2}
  ...
  \begin{multicols}{2}
      ...
      \begin{tikzpicture}[xscale=0.7, yscale=0.4]
        ...
        \foreach \y in {1, 3, ..., 13} \draw (2pt,\y cm) -- (-2pt,\y cm) node[anchor=east] {$\y$};
      \end{tikzpicture}
      \end{center}
    \end{multicols}
\end{enumerate}

\item A relation composed of four points is plotted on the graph below, and represented as a set of ordered pairs as $\{ (-1,5),(j,1),(4,3),(5,k) \}$.  \hfill [5]
\begin{multicols}{2}
\begin{enumerate}
  \item Write down $j$
  \item Write down $k$
