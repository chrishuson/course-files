...
\begin{tikzpicture}
  \draw[thick] (0,0)--(5,0);
  \draw[thick, yshift=2cm] (0,0)--(5,0);
    \draw[{Straight Barb[red,reversed, scale=2]}-{Straight Barb[red,scale=2]}] (2.5,0)--+(0.5,0);
    \draw[\paraticks, yshift=2cm] (2.5,0)--+(0.5,0);
  \draw[thick] (0,0)--(0,2);
  \draw[thick, xshift=5cm] (0,0)--(0,2);
    \draw[{Bar[scale=2]}-{Bar[scale=2]}] (0,1)--+(0,0.2);
    \draw[\ticks, xshift=5cm] (0,1)--+(0,0.2);
  \end{tikzpicture}
