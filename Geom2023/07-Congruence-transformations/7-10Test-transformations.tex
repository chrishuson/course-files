...
\fancyhead[LO]{BECA / Dr. Huson / Geometry\\*  Unit 8: Congruence transformations\\* 10 February 2023}

\begin{document}

\subsubsection*{7.10 Test: Rigid motions, translation, reflection, rotation}
\begin{enumerate}
...
\item On the axes below, plot the point $A(-4,-1)$ and its image, $A'$, after the translation $(x,y) \rightarrow (x+6,y-3)$. Label the image as a coordinate pair.
  ...
  \item The image of triangle $PQR$ after a reflection is $\triangle P'Q'R'$. Is the area of the triangle greater, smaller, or the same after the reflection? Justify your answer. \vspace{3cm}
...
\item What are the coordinates of the image of $B(2,5)$ after a reflection across the $x$-axis?  \vspace{0.1cm}
  \begin{multicols}{2}
    \begin{enumerate}
    \item $(-2,5)$
    \item $(5,2)$
...
\newpage
\item Which of the following would map $\triangle CAT \rightarrow \triangle C'A'T'$?  \vspace{0.1cm}
  \begin{multicols}{2}
    \begin{itemize}
...
\item What are the coordinates of the image of $C(3,1)$ after a rotation of $90^\circ$ counterclockwise around the origin?
  \begin{multicols}{2}
    \begin{enumerate}
      \item $(3,-1)$
      \item $(-1,3)$
...
\item Apply a translation of $(x,y) \rightarrow (x+7, y+3)$ to $\triangle JKL$ and then reflect the image across the $x$-axis. Draw both images $\triangle J'K'L'$ and $\triangle J''K''L''$ on the set of axes below, labeling the vertices.
  \begin{center}
    \begin{tikzpicture}[scale=.6]
      ...
      \draw [thick, <->] (0,-5.4)--(0,5.4) node [above] {$y$};
      \draw [thick]
        (-5,-1) node[below left] {$J$}--
        (-1,1) node[right] {$K$}--
        (-2,-2) node[below left] {$L$}--
      cycle;
