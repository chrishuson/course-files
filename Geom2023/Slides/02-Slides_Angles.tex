...
\begin{frame}{Learning Target: I can bisect angles}
  ...
  \begin{tikzpicture}[scale=1]
    \draw[<->, thick]
      ...
      pic["$7x-2$", <->, draw=black, angle eccentricity=1.7, angle radius=1cm]
      {angle=a--b--c};
      \draw[<->, thick]
      (-2,0.67) coordinate (d) %node[right] {P}
      -- (0,0) coordinate (e) %node[left] {Q}
      -- (-2,-1.5) coordinate (f) %node[above right] {R}
      pic["$61^\circ$", <->, draw=black, angle eccentricity=1.4, angle radius=1cm]
      {angle=d--e--f};
...
\section{2.5 Equilateral, isosceles $\triangle$ angles \hfill 4 October}
