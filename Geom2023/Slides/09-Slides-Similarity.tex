...
\section{9.6 Composition \hfill 22 March \,}
\begin{frame}{Learning Target: I can calculate distance}
  {HSG.SRT.B.5 Use similarity criteria for triangles to solve problems \hfill \alert{9.6 Wednesday 22 March}}
  \begin{columns}
    \column{0.4\textwidth}
    Do Now:\\
    The triangle is rotated around its longer leg. What 3-dimensional shape does it make? \\[0.5cm]
    Lesson: Regent pointers (be on time tomorrow, with calculator) \\[0.5cm]
    Homework: Complete the classwork practice, Deltamath problem set \\[0.5cm]
    \column{0.6\textwidth}
    \begin{flushright}
      \begin{tikzpicture}[scale=0.8]
