...
\section{1.1 Segment addition, 13-14 Sept}
...
\begin{frame}{A \emph{diagram} is a simplied image representing a situation}
  ...
  \begin{block}{When making diagrams}
    Include common elements: labels, titles, distances\\
...
\frame
{
  \frametitle{Segment addition practice}
...
\frame
{
  \frametitle{Segment addition with fractions}
...
{
  \frametitle{Segment bisector example}
