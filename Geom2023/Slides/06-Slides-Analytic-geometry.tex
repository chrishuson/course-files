...
\begin{frame}{Learning Target: I can plot a midpoint on the plane}
  {HSG.CO.C.9 Prove theorems about lines and angles  \hfill \alert{6.1 Wednesday 8 December}}
  \begin{block}{Do Now}
    \begin{enumerate}
  ...
  \end{block}
    ...
    Homework: Deltamath classwork practice
\end{frame}
  ...
  \begin{columns}
    ...
    \begin{flushright}
      \begin{tikzpicture}[scale=0.6]
        ...
        \draw [fill] (3,1) circle [radius=0.1] node[above right] {$(3,1)$};
        \draw [fill] (-1,3) circle [radius=0.1] node[above left] {$(-1,3)$};
      \end{tikzpicture}
    \end{flushright}
  \end{columns} \vspace{0.5cm}
\end{frame}
