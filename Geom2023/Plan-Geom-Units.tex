...
\begin{tabular}{|p{0.9cm}|p{4cm}|p{7cm}|p{5cm}|}
  ...
  \hline
  10/21 & 3.4 Parallelograms & Definitions, opposite sides $\cong$ & Polygon internal angles \\
  \hline
  10/24 & 3.5 External angles & $\triangle$ external angles &  \\
  \hline
  10/25 & 3.6 Transversal situations & Multiple steps: angle pairs, isosceles $\triangle$s & Polygon external angles \\
  \hline
  10/27 & 3.7 (Alg) Parallelogram situations & Examples of parallelogram properties &  \\
  \hline
  10/31 & 3.8 Review & Roundtable: Transversal naming conventions, solving for angles, parallelograms, situations & \\
  \hline
  11/1 & 3.9 Test: Transversals & Parallel line situations, implications for polygons &  \\
  \hline
...
\begin{tabular}{|p{0.9cm}|p{4cm}|p{7cm}|p{5cm}|}
  ...
  Date & Lesson title & Topics  & Extension topics \\
  \hline
  11/3 & 4.1 Nets of prisms & Definitions, folding &  \\
  \hline
  11/4 & 4.2 Surface area & Rectangular prisms &  \\
  \hline
  11/7 & 4.3 Volume & Prisms, cubes, units &  \\
  \hline
  11/8 & 4.4 Solve for a side & Algebra application, rectangular prisms, solve for area of base &  \\
  \hline
  11/10 & 4.5 Exponent review & Squaring, cubic, radicals & Exponent rules \\
  \hline
  11/14 & 4.6 Spheres, cones, pyramids & Volume formulas, solve for parameter & Simplifying radicals \\
  \hline
  11/15 & 4.7 2-D Density & Population density, cost calculations &  \\
  \hline
  11/17 & 4.8 Weight & Density calculations of a volume, multi-step problems & \\
  \hline
  11/18 & 4.9 Review & Roundtable: &  \\
  \hline
  11/20 & 4.10 Test: Volume and polyhedra &  &  \\
  \hline
