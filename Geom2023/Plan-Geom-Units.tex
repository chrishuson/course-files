...
\begin{tabular}{|p{0.9cm}|p{4cm}|p{7cm}|p{5cm}|}
  ...
  Date & Lesson title & Topics  & Extension topics \\
  \hline
  3/5 & 8.1 Pick a topic &  &  \\
  \hline
  3/6 & 8.2 Outline, Intro &  &  \\
  \hline
  3/7 & 8.3 Diagrams &  &  \\
  \hline
  3/8 & 8.4 Text body &  &  \\
  \hline
  3/9 & 8.5 Diagrams &  & Mock Regents (YTD) \\
  \hline
  3/7 & 8.6 Text body & Early finishers: compass, flower of life design &  \\
  \hline
  3/9 & 8.7 Peer review &  &  \\
  \hline
...
\begin{tabular}{|p{0.9cm}|p{4cm}|p{7cm}|p{5cm}|}
  ...
  Date & Lesson title & Topics  & Extension topics \\
  \hline
  1/17 & 9.1 Dilation & Triangle graphing, angle correspondence & Fraction division \\
  \hline
