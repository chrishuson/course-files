...
\item The compound shape shown below is composed of a square with side length 3 cm and a triangle with base 2 cm. Find the total area of the combined shape.
  \begin{flushleft}
  \begin{tikzpicture}[scale=0.8]
    \draw[thick] (2,0)--(7,0)--(5,3)--(2,3)--cycle;
    \draw[dashed] (5,0)--(5,3);
    \node at (6, -0.5){2};
    \node at (3.5, -0.5){3};
    \node at (1.5, 1.5){3};
