...
\subsubsection*{3.6 Classwork: External angles of triangles}
\begin{enumerate}
...
\item Given two parallel lines that intersect a transversal,  $\overleftrightarrow{DE} || \overleftrightarrow{BC}$. $m\angle ABC =3x-5$ and $m\angle BDE=6x+5$. \\[0.5cm]
