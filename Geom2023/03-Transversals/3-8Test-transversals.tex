...
\item Given parallel lines $\overleftrightarrow{AB} \parallel \overleftrightarrow{CF}$, $m\angle BAE=67^\circ$ and $m\angle DAE=48^\circ$. \\[0.5cm]
  ...
  \begin{tikzpicture}[scale=1.]
    ...
    \draw [-, thick] (1,0) node[below]{$D$}--
      (2.5,3) node[above]{$A$}--
      (4.35,0) node[below]{$E$};
    \node at (2.6,2.4)[below]{$48^\circ$};
    \node at (2.9,2.8)[below right]{$67^\circ$};
