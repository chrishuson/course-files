...
\fancyhead[L]{BECA / Dr. Huson / 10th Grade Geometry\\* 13 February 2020}

\begin{document}
\subsubsection*{8.12b Do Now: Compound volumes}
 \begin{enumerate}
  ...
  \item Circle $O$ has a radius $AO=10$, as shown below, and $m\angle AOB=90^\circ$.
  \begin{enumerate}
    ...
    \item Find the length of the arc $\wideparen{AB}$. %\vspace{3.5cm}
      ...
      \begin{tikzpicture}[scale=.35]
        ...
        \draw [thick] (0,0)--(90:5) node[above left] {$B$};
        \fill (0,0) circle[radius=0.1] node[below]{$O$};
        \draw (40:1.2) node{$90^\circ$};
  ...
  \item What is the area or the remaining part of the circle, without the sector.
