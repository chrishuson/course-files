...
\fancyhead[LO]{BECA / Dr. Huson / Geometry\\* Unit 6: Distance \& slope\\* 16 January 2019}

\begin{document}
\subsubsection*{7.11b Do Now: Transformations}
  \begin{enumerate}

  \item Apply a dilation mapping $\triangle ABC \rightarrow \triangle A'B'C'$ with a factor of $k=1.5$ centered at $(3,4)$. Draw and label the image on the grid and make a table of the coordinates.
    ...
    \begin{tikzpicture}[scale=.635]
      ...
      \draw [thick] (1,3)--(5,0)--(5,5)--cycle;
      \draw [fill] (1,3) circle [radius=0.1]node[below left]{$A$};
      \draw [fill] (5,0) circle [radius=0.1]node[below left]{$C$};
      \draw [fill] (5,5) circle [radius=0.1]node[above left]{$B$};
      \draw [fill] (3,4) circle [radius=0.1];
    \end{tikzpicture}
    \end{flushright}
    
  \item Find the image of $P(1,7)$ after a reflection over the $y$-axis.  \vspace{2cm}
...
\newpage
  ...
  \item A translation maps $A(5, -1) \rightarrow A'(5,4)$. What is the image of $B(7,-1)$ under the same translation? \vspace{1cm}
