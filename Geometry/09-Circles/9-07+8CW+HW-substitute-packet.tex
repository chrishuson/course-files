...
\fancyhead[L]{BECA / Dr. Huson / 10th Grade Geometry\\* 5 April 2019}
...
\subsubsection*{9.7 Classwork: Area and volume calculations}
 ...
 \item Circle $O$ has a diameter $AB=6$, as shown.
       ...
       \begin{tikzpicture}[scale=.6]
         ...
         \draw (0,0)--(110:5) node[above left] {$C$};
...
\item Given circle $O$ with chords $\overline{AD}$ and $\overline{BE}$ intersecting at $C$, as shown in the diagram. Given $m \wideparen{AB}=70^\circ$, $m \wideparen{BD}=80^\circ$, and $m \wideparen{DE}=90^\circ$.
  \begin{multicols}{2}
   ...
   \begin{tikzpicture}[scale=.6]
     ...
     \draw (140:1.2) node[below] {$C$};
     \draw (20:5) node[right] {$90^\circ$};
...
\newpage
  ...
  \newpage
  \setcounter{page}{1}
\subsubsection*{9.7 Homework: Area and volume calculations}
 \begin{enumerate}
   ...
   \item In right triangle $ABC$ shown below, point $D$ is on $\overline{AB}$ and point $E$ is on $\overline{BC}$ such that $\overline{AC} \parallel \overline{DE}$. Given $BD=10$, $BC=12$, and $EC=4$.
    ...
    \begin{enumerate}
      ...
      \item Find $AD$. \vspace{2.5cm}
     \end{enumerate}

     \item Given isosceles $\triangle ABC$ with $\overline{AC} \cong \overline{BC}$, and $m\angle BCD=136^\circ$. Find $m\angle A$.\\[1cm]
       \begin{tikzpicture}
         %\draw [->, thick] (0,0)--(5,5);
         \draw [<-, thick] (8,0)--(0,0)--(1,3)--(5,0);
         \draw [fill] (0,0) circle [radius=0.05] node[below]{$A$};
         \draw [fill] (5,0) circle [radius=0.05] node[below]{$C$};
         \node at (5,0) [above right]{$136^\circ$};
...
\item Given circle $O$ with radius $OB=9$.
  \begin{multicols}{2}
   ...
   \begin{enumerate}
     ...
     \item Given that $m\angle AOB=72^\circ$, find $m \wideparen{AB}$. \vspace{1cm}%yhmath package
  ...
  \begin{multicols}{2}
   ...
   \end{enumerate}
     \begin{tikzpicture}[scale=.5]
       ...
       \draw [thick] (0:5)--(210:5) node[below left] {$Q$}--(110:5);
       \draw (60:5) node[right]{$110^\circ$};
     \end{tikzpicture}
  \end{multicols}
\newpage
