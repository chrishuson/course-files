...
\begin{document}
\subsubsection*{13.4 Do Now: Construction \& similarity pre-quiz}
...
\newpage
  ...
  \begin{multicols}{2}[\item Given $\overline{APJ}$ and $\overline{KPB}$ as shown below. $\overline{AB} \parallel \overline{JK}$. $AP=6$, $JP=10$, and $BP=3$. \vspace{0.5cm} ]
    \begin{enumerate}
    ...
    \begin{tikzpicture}[scale=1.3]
        \draw [thick]
          ...
          (-2.5,0)node[above]{$A$}--cycle;
      \end{tikzpicture}
   \end{multicols} \vspace{1.5cm}

 \begin{multicols}{2}[\item Given the diagram below, with $\overline{ABD}$, $\overline{ACE}$, and $\angle ABC \cong \angle AED$. Also, $AB=30$, $AC=24$, and $BD=12$. \vspace{0.5cm} ]
     \begin{enumerate}
...
\newpage
  ...
  \begin{multicols}{2}[
    \item In the diagram below, the chords $\overline{AE}$ and $\overline{BD}$ intersect at $C$. Given that $AC=8$, $BC=10$, and $CE=20$. The arc measure of $m \wideparen{AD}=170^\circ$. %uses yhmath
    \vspace{0.5cm}
      ]
    \begin{enumerate}
   ...
   \begin{multicols}{2}[
     \item In the diagram below, the chords $\overline{AD}$ and $\overline{BE}$ intersect at $C$. Given that $AC=12$, $BC=15$, and $CD=20$.
     \vspace{0.5cm}
       ]
     \begin{enumerate}
       \item $\triangle ABC \sim$ \rule{2cm}{0.15mm} \vspace{0.7cm}
...
\newpage
\setcounter{page}{1}
\subsubsection*{13.4 Exit Note: Construction \& similarity quiz}
Use only a compass and straightedge for these classical constructions, showing all construction marks.
  \begin{enumerate}
  ...
  \item Construct the perpendicular bisector to $\overline{AB}$.
    ...
    \begin{tikzpicture}
      ...
      \draw [fill] (4,5) circle [radius=0.05] node[below right]{$B$};
    \end{tikzpicture}
  \end{center} \vspace{2cm}
...
\newpage
  ...
  \begin{multicols}{2}[
    \item In the diagram below, the chords $\overline{AD}$ and $\overline{BE}$ intersect at $C$. Given that $AC=5$, $BC=4$, and $CD=10$.
    \vspace{0.5cm}
      ]
    \begin{enumerate}
      \item $\triangle ABC \sim$ \rule{2cm}{0.15mm} \vspace{0.7cm}
