...
\newpage
  ...
  \item Given triangle $ABC$ with $D$ the midpoint of $\overline{AB}$ and $E$ the midpoint of $\overline{AC}$, as shown. Given $AD=9$, $BD=2x-5$, $DE=y+7$, and $BC=3y+3$. \\[0.25cm] Find $x$ and $y$. \vspace{1cm}
    \begin{center}
