...
\fancyhead[L]{BECA / Dr. Huson / 10th Grade Geometry\\* 18 March 2019}

\begin{document}
\subsubsection*{8-10 Do Now: Similar triangles, dilation ratios}
 \begin{enumerate}
...
\subsubsection*{8-10 Homework: Pretest on similar triangles, dilation, \& symmetry}
 \begin{enumerate}
  ...
  \item What series of transformations map $\triangle ABC$ onto $\triangle DEC$, shown below? Fully specify the transformations.
    \begin{center}
      \begin{tikzpicture}[scale=.48]
