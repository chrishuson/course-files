...
\fancyhead[L]{BECA / Dr. Huson / 10th Grade Geometry\\* 17 April 2019}
...
\newpage
    \item The vertices of $\triangle JKL$ have the coordinates $J(-4,-2)$, $K(2,0)$, and $L(-2,4)$, and the point $P(-1,1)$ is marked, as shown. \\[0.25cm]
      ...
      \begin{center}
        \begin{tikzpicture}[scale=.48]
          ...
          (2,0) node[below right] {$K$}--
          (-2,4) node[above right] {$L$}--
          cycle;
          \draw [fill] (-1,1) circle[radius=0.1cm] node[left]{$P$};
        \end{tikzpicture}
      \end{center}

\item Given circle $P$ with $m \angle APB=64^\circ$.
  \begin{multicols}{2}
   \raggedcolumns
   \begin{enumerate}
   ...
   \end{enumerate}
     \begin{tikzpicture}[scale=.5]
       ...
       \draw (35:0.4) node[right]{$64^\circ$};
...
\newpage
  ...
  \item Given circle $O$ with chords $\overline{AD}$ and $\overline{BE}$ intersecting at $C$, as shown in the diagram. Given $m \wideparen{AB}=80^\circ$, $m \wideparen{BD}=94^\circ$, and $m \wideparen{DE}=66^\circ$.
    \begin{multicols}{2}
     \raggedcolumns
     \begin{enumerate}
     ...
     \begin{tikzpicture}[scale=.5]
       ...
       \draw (85:1.5) node{$C$};
       \draw (20:5) node[right] {$66^\circ$};
       \draw (80:5) node[above] {$94^\circ$};
       \draw (155:5) node[left] {$80^\circ$};
      \fill (0,0) circle[radius=0.1] node[below]{$O$};
     \end{tikzpicture}
   \end{multicols}  \vspace{1cm}

\item The secants $\overline{ABC}$ and $\overline{ADE}$ intersect the circle $O$, as shown in the diagram. \\Given $m \wideparen{BD}=35^\circ$ and $m \wideparen{CE}=155^\circ$. Find the $m\angle A$.
     \begin{center}
     \begin{tikzpicture}[scale=.5]
       ...
       \draw (20:5) node[right] {$155^\circ$};
       \draw (160:5) node[right] {$35^\circ$};
     \end{tikzpicture}
   \end{center} %\vspace{1cm}

    \item The secants $\overline{PQR}$ and $\overline{PST}$ intersect the circle $O$, as shown in the diagram. \\Given $m \angle P=43^\circ$ and $m \wideparen{RT}=150^\circ$. Find the $m\wideparen{QS}$.
         \begin{center}
         \begin{tikzpicture}[scale=.5]
           \draw [thick] (0,0) circle[radius=5];
           \draw [thick]
           ...
           \draw (0:5) node[right] {$150^\circ$};
           \draw (-8,-1.8) node[right] {$43^\circ$};
         \end{tikzpicture}
       \end{center} \vspace{1cm}

\newpage
    \item Given $P(7,-4)$ and $Q(5,0)$, find the length of $\overline{PQ}$. Simplify the radical.\vspace{4cm}

  \item In the diagram below, $\triangle ABC \sim \triangle DEF$, $DE=10$, $AB=x$, $AC=3x$, and $DF=5x$. Determine the length of $\overline{AB}$.
    \begin{center}
      ...
      \coordinate [label=right:$C$](C) at (-20:3);
        ...
        \draw [thick, xshift=5cm, yshift=0.5cm](30:2.75) node[right]{$5x$};
    \end{tikzpicture}
  \end{center} \vspace{2cm}

   \item In right triangle $ABC$ shown below, point $D$ is on $\overline{AB}$ and point $E$ is on $\overline{BC}$ such that $\overline{AC} \parallel \overline{DE}$. If $AB=20$, $BC=15$, and $AD=14$, what is the length of $\overline{BE}$?
     \begin{center}
...
\newpage
  ...
  \item What is the length of the segment $A(2,10)$, $B(-3,-2)$?
    \vspace{4cm}

  \item What is the equation of a line through the point $A(6,-1)$ and parallel to the line $y=\frac{1}{3}x+2$? (hint: use the point-slope formula, $y-y_A=m (x-x_A)$) \vspace{2.5cm}
