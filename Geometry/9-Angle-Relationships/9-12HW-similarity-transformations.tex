...
\begin{document}
\subsubsection*{9-12 Homework: Review Similar triangles, dilation ratios, transformations}
 \begin{enumerate}
  ...
  \item After a dilation with center $(0,0)$, the image of $\overline{RS}$ is $\overline{R'S'}$. If $RS=6.4$ and $R'S'=32$, find the scale factor of this dilation. \vspace{3cm}
