...
\section{6.4 Drui: Dilation construction, ratios. Wednesday 9 January}
  \frame
  {
    ...
    \begin{block}{Do Now: Handout}
      ...
      \end{enumerate}
    \end{block}
    Dilation construction, on coordinate plane, ratios\\[0.5cm]
    Homework: Multiple choice exercises, handout\\[0.5cm]
    Take-home test Friday (Multiple choice)
  }
...
\section{6.5 Drui: Triangle similarity leg calcs, midline. Thursday 10 Jan}
  \frame
  {
    ...
    \begin{block}{Do Now: Handout}
      \begin{enumerate}
        \item Triangle proof with reflexive property handout
      \end{enumerate}
    \end{block}
    Review homework (gradecam scores)\\
    Similarity, triangle dilations and midline/parallels situations\\[0.5cm]
    Homework: Similar triangles exercises, handout\\
    Take-home test tomorrow (Multiple choice)
  }
...
\section{6.6 Drui: Trig similarity. Friday 11 January}
  \frame
  {
    ...
    \begin{block}{Do Now: Handout}
      ...
      \end{enumerate}
    \end{block}
    Right triangle dilation situations, trig\\[0.5cm]
    Homework: Take-home test (Multiple choice)
  }
