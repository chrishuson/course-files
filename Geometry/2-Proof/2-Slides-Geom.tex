...
\section{2.11 Drui: Addition proofs, transversals. Monday 29 October}
  \frame
  {
    \frametitle{GQ: How do we add or subtract a common measure?}
    \framesubtitle{CCSS: HSG.CO.C.9 Prove geometric theorems \hspace{\stretch{1}} \alert{2-11}}

    \begin{block}{Do Now: Exam problem followup}
    \begin{enumerate}
        \item Given two segments with a common section, show congruence equivalence
        \item Show congruence equivalence for adjacent angles in additive configuration
        \item Given the triangle, construct a perpendicular through a vertex
        \item Connect the vertex to the opposite midpoint, draw the median
    \end{enumerate}
    \end{block}
    ...
    Classwork problems 5-13 p. 117\\
    \vspace{0.5cm}
    Homework: Construct the midpoint, medians
  }
...
\section{2.13 Drui: Transversals. Wednesday 31 October}
  \frame
  {
    ...
    \begin{block}{Do Now: Exam problem followup}
    \begin{enumerate}
        \item Given the triangle calculate the midpoint
        \item Given the triangle, construct the midpoint of each side
        \item Connect the vertex to the opposite midpoint, draw the median
    \end{enumerate}
    \end{block}
    Transversal and corresponding angles
    ...
    Classwork problems 5-13 p. 117\\
    \vspace{0.5cm}
    Homework: Triangle center project, take home test (mild \& spicy)
  }
