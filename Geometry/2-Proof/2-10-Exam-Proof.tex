...
\newpage
  \item Given $\overleftrightarrow{QS}$ as shown on the number line, with $Q$ having the coordinate 2.55 and $S$ the coordinate 5.23. \\[20pt] % Midpoint
    \begin{tikzpicture}
      \draw [<->] (-4.5,0)--(6.5,0);
