...
\item[2.] \textbf{Quadratic in log.} Solve for $x$:
...
\item[4.] \textbf{Solve for the exponent.} When $x$ is in the exponent,
take the logarithm of both sides. Give exact answers.
