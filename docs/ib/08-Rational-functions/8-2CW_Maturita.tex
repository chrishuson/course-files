...
\draw [thin, color=lightgray, xstep=0.5cm, ystep=0.5cm] (-5.5,-5.5) grid (5.5,5.5);
\draw [thick, color=gray, xstep=1.0cm, ystep=1.0cm] (-5.5,-5.5) grid (5.5,5.5);
...
\draw [thin, color=lightgray, xstep=0.5cm, ystep=0.5cm] (-4.5,-2.5) grid (6.5,3.5);
\draw [thick, color=gray, xstep=1.0cm, ystep=1.0cm] (-4.5,-2.5) grid (6.5,3.5);
...
\draw [thick, ->] (0,-2.7) -- (0,3.9) node [above] {$y$};
...
\draw [thin, color=lightgray, xstep=0.5cm, ystep=0.5cm] (-5.5,-5.5) grid (6.5,8.5);
\draw [thick, color=gray, xstep=1.0cm, ystep=1.0cm] (-5.5,-5.5) grid (6.5,8.5);

\foreach \x in {-5,-4,-3,-2,-1,1,2,3,4,5,6}
\draw[shift={(\x,0)}, color=black] (0pt,-2pt) -- (0pt,2pt) node[below] {$\x$};

\foreach \y in {-5,-3,-1,1,3,5,7}
\draw[shift={(0,\y)}, color=black] (2pt,0pt) -- (-2pt,0pt) node[left] {$\y$};

\draw [thick, ->] (-5.7,0) -- (6.9,0) node [right] {$x$};
\draw [thick, ->] (0,-5.7) -- (0,8.9) node [above] {$y$};
