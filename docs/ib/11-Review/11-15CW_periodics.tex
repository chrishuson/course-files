...
The weight is released when its base is at a minimum height of $1$ metre above the ground, and it reaches a maximum height of $1.8$ metres above the ground. The graph of $H$ is shown
...
The six blades of a windmill rotate around a centre point $C$. Points $A$ and $B$ and the base of the windmill are on level ground.
