...
% --------------------------------------------------
\item Eight piano students reported their average weekly practice time and their diploma score (out of 150). The data are shown below.
...
% --------------------------------------------------
\item A runner collects data to see whether the time to run $5000$ m depends on the runner’s age. For eight male runners he records:
...
% --------------------------------------------------
\item In an experiment the area of a mould patch is modelled by
\[
P(t) = A e^{kt},
\]
...
% --------------------------------------------------
\item Dilara is designing a kite $ABCD$ on a coordinate plane (1 unit = 10 cm). The points are
\[
...
% --------------------------------------------------
\item A new university records the number of applications in its first two years:
...
\vspace{0.25cm}
  ...
  \item Give all numerical answers correct to two decimal places.
...
\item A population of rare birds, $P_t$, can be modelled by the equation
$$P_t = P_0 e^{kt},$$
...
\item The price of a used car depends partly on the distance it has travelled. The following table shows the distance and the price for seven cars on 1 January 2010.
...
% =========================================================
\section*{2. Sequences: geometric and arithmetic}

\textbf{Part A (geometric sequence)}
...
\textbf{Part B (arithmetic sequence)}
...
\item The mass $M$ of a decaying substance is measured at one–minute intervals. The points $(t, \ln M)$ are plotted for $0 \le t \le 10$, where $t$ is in minutes. The line of best fit is drawn. This is shown in the diagram.
