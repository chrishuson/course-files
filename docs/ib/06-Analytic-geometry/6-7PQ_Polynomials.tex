...
\begin{document}
\subsubsection*{6.7 PreQuiz: Polynomials (no calculator)}

\begin{enumerate}[itemsep=0.15cm]

%--- Problem 1: Standard form to factored and vertex form [7 marks] ---
...
\begin{enumerate}[itemsep=0.15cm]
  ...
  \item Show that $g(x) = -x^2 + 8x - 7$. \hfill [2]
...
%--- Problem 3: Intersection of line and parabola [7 marks] ---
\item[3.] [Maximum mark: 7]

The line $y = 2x$ and the parabola $y = x^2 - 3$ are drawn
on the same axes.
...
\begin{enumerate}[itemsep=0.15cm]
  ...
  satisfy \\[0.25cm]
  $x^2 - 2x - 3 = 0$. \hfill [2]
  \item Show that $x^2 - 2x - 3=0$ has two distinct real roots. \hfill [1]
  \item Factorise $x^2 - 2x - 3$. \hfill [1]
