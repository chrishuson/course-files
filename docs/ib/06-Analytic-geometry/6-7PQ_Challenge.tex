...
\begin{document}
\subsubsection*{6.7 PreQuiz: Polynomials Challenge (no calculator)}
...
to the parabola $y = x^2 + 4$.

\begin{enumerate}[itemsep=0.15cm]
  \item Show that at any point of intersection,
  $x^2 - mx + 4 = 0$. \hfill [1]
  \item Find the discriminant of $x^2 - mx + 4 = 0$
...
\begin{enumerate}[itemsep=0.15cm]
  \item Show that $(x + 2)$ is a factor of $p(x)$. \hfill [2]
  \item Hence express $p(x)$ in the form
  $(x + 2)(ax^2 + bx + c)$. \hfill [2]
