...
$x^2 + 16 = mx$ \hfill \textbf{M1}

$x^2 - mx + 16 = 0$ \hfill \textbf{AG}
...
Justification: $\Delta = 60 > 0$, so two distinct real roots. \hfill \textbf{R1}
