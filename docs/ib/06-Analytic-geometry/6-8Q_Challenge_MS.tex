...
$f(1) = -2(1 + 2)(1 - 4) = -2(3)(-3) = 18$ \hfill \textbf{(A1)}

Vertex: $(1, 18)$ \hfill \textbf{(A1)}
...
\emph{Verification: $-2(x - 1)^2 + 18 = -2(x^2 - 2x + 1) + 18
= -2x^2 + 4x - 2 + 18 = -2x^2 + 4x + 16$}

\emph{And: $-2(x + 2)(x - 4) = -2(x^2 - 2x - 8) = -2x^2 + 4x + 16$ \checkmark}
...
$x^2 + 9 = mx \implies x^2 - mx + 9 = 0$ \hfill \textbf{(A1)(AG)}
...
Tangent: $\Delta = 0 \implies m^2 - 36 = 0$ \hfill \textbf{(M1)}
...
For $m = 6$: $x^2 - 6x + 9 = 0 \implies (x - 3)^2 = 0
\implies x = 3$ \hfill \textbf{(M1)}
...
$= 2(x^2 - 4x + 4 - 4) + 3 = 2(x - 2)^2 - 8 + 3$ \hfill \textbf{(M1)}

$= 2(x - 2)^2 - 5$ \hfill \textbf{(A1)}
...
Since $\Delta = 40 > 0$, $f(x) = 0$ has two distinct real solutions. \hfill \textbf{(A1)}
