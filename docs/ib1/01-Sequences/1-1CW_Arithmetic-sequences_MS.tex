...
\begin{document}
\subsubsection*{1.1 Classwork: Arithmetic Sequences --- Markscheme}
...
$u_{n} = 7 + 4(n-1)$ \hfill \textbf{A1}

\emph{Accept the simplified form $u_{n} = 4n + 3$, or any other equivalent
