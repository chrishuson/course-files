...
\item The diagram below shows $\triangle ABC$. $E$ bisects $\overline{AB}$, and $\angle ACB \cong \angle AED$. $AB=18$, $AC=12$, and $DE=7$. Find the scale factor $k$, $BC$, and $AD$. % this diagram is not properly to scale
\begin{multicols}{2}
  \begin{enumerate}
    \item $k=$ \vspace{1cm}
    \item $BC=$ \vspace{1cm}
