...
\begin{enumerate}
\subsubsection*{{\tiny HSG.MG.A.1} Use geometric shapes, measures, and properties to describe objects}
...
\subsubsection*{{\tiny GPE.B.7} Compute perimeters and areas of triangles and rectangles}
...
\newpage
\subsubsection*{{\tiny HSA.CED.A.1} Create equations in one variable and use them to solve problems.}
