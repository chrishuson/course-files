...
\item In the diagram shown, $\overrightarrow{BD} \perp \overleftrightarrow{ABC}$ and angle measures are given.  \par \medskip 
  Find $x$. Show the check for full credit. \vspace{0.25cm}
    \begin{multicols}{2}
      m$\angle DBE = 4x+4^\circ$  \\[0.25cm]
      m$\angle EBC = 9x-5^\circ$  \par \vspace{3cm}
...
\item Ray $\overrightarrow{BF}$ is the angle bisector of $\angle ABC$. Given that the angle measures are \\ 
m$\angle ABF = 7x-14$ and m$\angle CBF = 5x+10$.  \par \bigskip 
  Find $x$. \vspace{0.5cm}
    \begin{flushright}
      \begin{tikzpicture}[scale=1]
        \draw[<->, thick]
...
\begin{multicols}{2}
  ...
  $\displaystyle A = \frac{1}{2} bh = 117$ \vspace{2cm}
    ...
    \begin{tikzpicture}[scale=.635]
      ...
      \draw[thick, ->] (-1.2,0) -- (9.1,0) node [below right] {$x$};
