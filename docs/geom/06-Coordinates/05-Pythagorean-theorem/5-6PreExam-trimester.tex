...
\item Given $\overline{ABC}$, $AB=\frac{2}{3}$, and $AC=3 \frac{1}{3}$. Find ${BC}$. \par \vspace{1cm}
  \begin{tikzpicture}
    \draw[thick] (1,0)--(7,0);
...
\item Given isosceles $\triangle ABC$ with $\overline{AC} \cong \overline{BC}$. $AC=5x+7$ and $BC=3x+17$. Find $AC$. \par \vspace{1cm}
...
\item Find the volume of a rectangular prism volume of water. Its length is $l=20$ feet, its height $h=12$ feet, and depth is $w=10$ feet.
  \begin{flushright}
...
\item A sphere has a radius of 5 centimeters. Find the volume of the sphere to the \emph{nearest whole cubic centimeter}. \vspace{3cm}
