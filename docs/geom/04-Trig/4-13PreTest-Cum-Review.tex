...
\item A dilation centered at $A$ with scale factor $k=2 \frac{1}{3}$ maps $\triangle ABC \rightarrow \triangle ADE$. Given the lengths $AC = 9$, $BC = 6$, $AB = 12$, and $DE = 14$. \\[0.25cm]
