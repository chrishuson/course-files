...
\frame
{
  \frametitle{GQ: How do we summarize data?}
  \framesubtitle{CCSS: HSS.CP.B.6 Find and interpret conditional probabilities \qquad \qquad \qquad \alert{11.2}}
