...
\frame
{
  ...
  \begin{block}{Do Now: Set theory}
  Create a Venn diagram organizing the people in room 414:\\* 
  A = the set of students in uniform, 
  \\*
  B = the set of males in the room\\*[15pt]
  \end{block}
  Lesson: Set theory review homework problem packets\\*[5pt]
  Task: Probability problem set\\*[5pt]
  Assessment: Classwork problem set \#1\\*[5pt]
