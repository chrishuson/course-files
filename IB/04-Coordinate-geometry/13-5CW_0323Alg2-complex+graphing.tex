...
\lhead{BECA / Dr. Huson / Mathematics \\* 10 June 2019 \\* IB Math SL}
...
\newpage
  ...
  Express $f(x) \bullet g(x) - f(x) + g(x)$ as a polynomial in standard form. \vspace{4cm} %Alg2 Regents Jan2018
