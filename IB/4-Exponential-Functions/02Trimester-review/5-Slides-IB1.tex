...
\frame{\tableofcontents}
  ...
  \section{5.8 Drui: Polynomial remainder theorem, Wednesday Jan 16}
    \frame
    {
      ...
      \framesubtitle{CCSS: HSF.IF.C.7 Analyze functions  \hspace{\stretch{1}}  \alert{5.8 Wednesday Jan 16}}
  ...
  \section{5.9 Drui: Polynomial remainder theorem, Thursday Jan 17}
    ...
    {
      \frametitle{GQ: How do we evaluate polynomial expressions?}
      \framesubtitle{CCSS: HSF.IF.C.7 Analyze functions  \hspace{\stretch{1}}  \alert{5.9 Thursday Jan 17}}
  ...
  \section{5.10 Drui: Deltamath Polynomials, Tuesday Jan 28}
    ...
    {
      \frametitle{GQ: How do we evaluate polynomial expressions?}
      \framesubtitle{CCSS: HSF.IF.C.7 Analyze functions  \hspace{\stretch{1}}  \alert{5.10 Tuesday Jan 28}}
