...
\lhead{BECA / Dr. Huson / 10.3 Geometry\\* 30 May 2019}
...
\begin{document}
  \begin{enumerate}
    \subsubsection*{Do Now: Graphing practice}
        ...
        \begin{multicols}{2}
        \item   $2x-10=4x-4$ \vspace{3cm}
        \item   $\frac{2}{3}(3x-9)=16$ %\vspace{3cm}
        \end{multicols}
...
\item Her points scored increased as a player practiced during the year.  The table shows how many points were scored at specific games in the season.
  \renewcommand{\arraystretch}{1.6}
    ...
    \begin{tikzpicture}[scale=.635]
      ...
      \draw [thick, ->] (0,0) -- (10.4,0) node [below right] {$Games$};
      \draw [thick, ->] (0,0)--(0,12.4) node [left] {$Points$};
