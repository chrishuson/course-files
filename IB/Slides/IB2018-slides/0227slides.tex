...
\frame
{
  \frametitle{GQ: How do we calculate conditional probability?}
  ...
  \end{enumerate}
  \end{block}
  Lesson: Conditional probability p. 696\\*[5pt]
  Task: Homework review; Heights vs gender probability distribution\\*[5pt]
  Assessment: Two cards are drawn from a deck, without replacement. Are the events independent?\\*[5pt]
  Homework: Workbook p. 283 
}
