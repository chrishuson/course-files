...
\frame
{
  \frametitle{How do we use and interpret exponential functions?}
  ...
  \begin{enumerate}
    \item Handout practice of graphing and factoring%Evaluate $f(x)=\sqrt{x^2}$ for $x=-2, -1, 0, 1, 2$
    ...
    \end{enumerate}
  \end{block}
  Lesson: Regents exponents checkpoint skills\\*
  Task: Deltamath - Complete mastery grid cells\\*
