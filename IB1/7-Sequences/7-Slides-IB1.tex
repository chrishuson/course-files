...
\section{7.1 Introduction and definitions Monday 18 March}
  ...
  \section{7.6 Geogebra Fibonacci sequence, Tuesday 25 March}
    \frame
    {
      \frametitle{GQ: How do we depict the Fibonacci sequence geometrically?}
      \framesubtitle{CCSS: HSF.BF.A.2 Write arithmetic and geometric sequences, use them to model situations \hfill \alert{7.6 Tuesday 25 March}}
