...
\section{1.7 Drui Review Thursday September 20th}
  \frame
  {
    ...
    \begin{block}{Do Now: Review pretest}
      \begin{enumerate}
      \item Function notation \& substitution
      \item Domain and range
      \item Factoring and solving quadratic equations
      \item Graphing quadratics, applications
      \end{enumerate}
   \end{block}
