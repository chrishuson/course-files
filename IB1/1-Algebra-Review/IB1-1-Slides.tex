...
\frame
{
  ...
  \frame
  {
    \frametitle{GQ: How do we simplify exponents?} %only the GQ is updated
    \framesubtitle{CCSS: HSF.IF.B.6 Calculate and interpret the rate of change of a function \hspace{\stretch{1}} \alert{1.6}}
    ...
    \begin{block}{Do Now: Sketch the function $f(x)=x^3-9x$}
      ...
      \end{enumerate}
   \end{block}
    Lesson: Product, quotient, power rules, $\sqrt{x^4}$ \\%*[5pt]
    Homework: Pre-test
  }
