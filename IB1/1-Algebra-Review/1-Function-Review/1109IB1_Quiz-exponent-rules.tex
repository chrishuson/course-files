...
\textit{Do these problems without a calculator. Answer in the space provided.}
\end{center}
...
\item $3x^{-2}y \times 2x^3y^{-1}$\\*[55pt]
\item $\sqrt{a^4b}$\\*[55pt]
\item $\displaystyle x^{\frac{1}{2}} \times (\frac{y}{z^3})^2$\\*[55pt]
\item $\displaystyle (a^6 b^2)^{\frac{1}{3}} \div a^{-1} b$\\*[55pt]
