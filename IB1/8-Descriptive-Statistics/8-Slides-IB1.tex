...
\section{8.6 Standard deviation Tuesday 13 May}
  \frame
  {
    \frametitle{GQ: How do we ``rangle" a dataset?}
    \framesubtitle{HSS.ID.A.1-4 Summarize, represent, and interpret data on a single measurement variable \hfill \alert{8.6 Tuesday 13 May}}
